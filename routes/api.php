...
Route::post('restablecer_acceso', [RestablecerContraseñaController::class, 'buscarUsuario'])->name('restablecerContraseña.buscarUsuario');
Route::post('restablecer_acceso/{token}', [RestablecerContraseñaController::class, 'restablecerContraseña'])->name('restablecerContraseña.restablecerContraseña');
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('/respuestas_seguridad', RespuestasSeguridadController::class)->parameters(['respuestas_seguridad'=>'respuesta_seguridad']);
